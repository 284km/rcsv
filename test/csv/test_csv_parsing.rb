...
class TestCSV::Parsing < TestCSV
  ...
  #     [";,;", [";", ";"]] ].each do |csv_test|
  #     assert_equal(csv_test.last, Rcsv.parse_line(csv_test.first))
  #   end
  #
  #   [ ["foo,\"\"\"\"\"\",baz", ["foo", "\"\"", "baz"]],
  #     ["foo,\"\"\"bar\"\"\",baz", ["foo", "\"bar\"", "baz"]],
  ...
  def test_aras_edge_cases
    [ [%Q{a,b},               ["a", "b"]],
      ...
      [%Q{"\r\n,",},          ["\r\n,", nil]] ].each do |edge_case|
        assert_equal(edge_case.last, Rcsv.parse_line(edge_case.first))
      end
  end

  def test_james_edge_cases
    # A read at eof? should return nil.
    assert_equal(nil, Rcsv.parse_line(""))
    #
  ...
  def test_malformed_csv
    # assert_raise(Rcsv:MalformedCSVError) do
    #   Rcsv.parse_line("1,2\r,3", row_sep: "\n")
    # end
    ...
    # assert_raise(CSV::MalformedCSVError) { Rcsv.parse_line('1,2,"3...') }
  ...
  # TODO: ruby/csv の実装と違う所...。通してしまっている
  ...
  def test_field_size_limit_in_extended_column_not_exceeding
    data = <<~DATA
      ...
      ",""
    DATA
    assert_nothing_raised(Rcsv::MalformedCSVError) do
      Rcsv.parse(data, field_size_limit: 4)
    end
  end
